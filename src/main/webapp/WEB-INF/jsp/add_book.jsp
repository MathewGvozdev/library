...
<form
    ...
    <input type="text" name="bookMetaId" placeholder="<fmt:message key="page.book.meta.id"/>" value="${param.bookMetaId}"><br>
    <input type="text" name="publisherId" placeholder="<fmt:message key="page.book.publisher.id"/>" value="${param.publisherId}"><br>
    <input type="text" name="pages" placeholder="<fmt:message key="page.book.pages"/>" value="${param.pages}"><br>
    <input type="text" name="publicationYear" placeholder="<fmt:message key="page.book.publication.year"/>" value="${param.publicationYear}"><br>
    <button type="submit">
